...
function Adminlogin() {
    ...
    return (
        <center>
            <div className="container-fluid" style={{ backgroundImage: `url(${contact1})`, height: '1000px', backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: 'cover' }}>
