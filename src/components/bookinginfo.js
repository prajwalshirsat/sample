...
export default class BookingInfo extends React.Component {
    ...
    componentDidMount = () => {
        ...
        fetch("http://localhost:8081/BookingInfo/bookinginfobyid/" + JSON.parse(localStorage.getItem('loggedincustomer')).userId)
            .then(resp => resp.json())
            .then(data => {
    ...
    render() {
        return (
            <div className="container-fluid" style={{ backgroundImage: `url(${reg})`, height: '1000px', backgroundPosition:"center", backgroundRepeat: "no-repeat", backgroundSize: 'cover', color: 'white' }}>
            <div class="nav">&nbsp;&nbsp;
