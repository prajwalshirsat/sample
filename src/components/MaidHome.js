...
export default class MaidHome extends React.Component {
    ...
    componentDidMount = () => {
        ...
        console.log(maidId);
        fetch('http://localhost:8081/BookingInfo/bookinginfoformaid/' + maidId)
            .then(resp => resp.json())
            .then(data => {
    ...
    getAllMaids = (c) => {
        ...
        fetch("http://localhost:8081/getAllMaidsByCategory/" + (c))
    ...
    render() {
        ...
        return (
            <div style={{ backgroundImage: `url(${reg})`, height: '1000px', backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: 'cover' }}>
