...
class Feedback extends React.Component {
  ...
  submit = (event) => {
    ...
    fetch('http://localhost:8081/MaidReview/maidreviewinsert/' + maidId + '/' + userId, requestOption)
      .then(res => {
        if (res.status == 200) {
  ...
  render() {
    ...
    return (
      <div className="container-fluid" style={{ backgroundImage: `url(${we})`, height: '695px', backgroundRepeat: "no-repeat", backgroundSize: 'cover' }}>
        <div class="nav">&nbsp;&nbsp;
