...
class UpdateMaid extends React.Component {
  ...
  update = (event) => {
    ...
    fetch('http://localhost:8081/maid/maidupdate/' + maidId, requestOption)
      .then(res => {
        if (res.status === 200) {
  ...
  render() {
    ...
    return (
      <div className="container-fluid" style={{ backgroundImage: `url(${reg})`, height: '1000px', backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: 'cover', color: 'black' }} >
        <div class="nav">&nbsp;&nbsp;
