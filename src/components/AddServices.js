...
class AddServices extends React.Component {
  ...
  submitdata = e => {
    ...
    axios.post('http://localhost:8081/services/servicesinsert', this.state) //connection to backend 
  ...
  render() {
    ...
    return (
      <form onSubmit={this.submitdata}>
        <div className="Container-fluid" style={{ backgroundImage: `url(${qw})`, height: '1000px', backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: 'cover' }}>
          <div class="nav">&nbsp;&nbsp;
