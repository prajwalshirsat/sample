...
class MaidProfile extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="container-fluid" style={{ backgroundImage: `url(${we})`, height: '1000px', backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: 'cover', color: 'black' }} >
